...
namespace IO.Swagger.Api
{
    ...
    public interface IMazeApi : IApiAccessor
    {
        ...
        /// <param name="direction"></param>
        /// <returns>ApiResponse of PossibleActionsAndCurrentScore</returns>
        ApiResponse<PossibleActionsAndCurrentScore> MoveWithHttpInfo (string direction);
        /// <summary>
        ...
        /// <param name="direction"></param>
        /// <returns>Task of PossibleActionsAndCurrentScore</returns>
        System.Threading.Tasks.Task<PossibleActionsAndCurrentScore> MoveAsync (string direction);
        ...
        /// <param name="direction"></param>
        /// <returns>Task of ApiResponse (PossibleActionsAndCurrentScore)</returns>
        System.Threading.Tasks.Task<ApiResponse<PossibleActionsAndCurrentScore>> MoveAsyncWithHttpInfo (string direction);
        /// <summary>
        /// 👀 Get the list of possible actions, from the tile where you are standing.
        /// </summary>
        /// <remarks>
    ...
    public partial class MazeApi : IMazeApi
    {
        ...
        /// <summary>
        /// Move in the supplied direction. You must have already entered a maze. This method will return 200 even if you could not move in this direction. If there is a \&quot;wall\&quot; in your way and you try to move there.. well, it&#39;s gonna hurt, but you will remain in the same place.. which.. technically.. is valid.. 🤷🏻‍
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="direction"></param>
        /// <returns>PossibleActionsAndCurrentScore</returns>
        public PossibleActionsAndCurrentScore Move (string direction)
        {
             ApiResponse<PossibleActionsAndCurrentScore> localVarResponse = MoveWithHttpInfo(direction);
             return localVarResponse.Data;
        }
        ...
        /// <param name="direction"></param>
        /// <returns>ApiResponse of PossibleActionsAndCurrentScore</returns>
        public ApiResponse< PossibleActionsAndCurrentScore > MoveWithHttpInfo (string direction)
        {
            // verify the required parameter 'direction' is set
            if (direction == null)
                throw new ApiException(400, "Missing required parameter 'direction' when calling MazeApi->Move");

            var localVarPath = "/api/maze/move";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
        ...
        /// <param name="direction"></param>
        /// <returns>Task of PossibleActionsAndCurrentScore</returns>
        public async System.Threading.Tasks.Task<PossibleActionsAndCurrentScore> MoveAsync (string direction)
        {
             ApiResponse<PossibleActionsAndCurrentScore> localVarResponse = await MoveAsyncWithHttpInfo(direction);
             return localVarResponse.Data;
        ...
        /// <param name="direction"></param>
        /// <returns>Task of ApiResponse (PossibleActionsAndCurrentScore)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PossibleActionsAndCurrentScore>> MoveAsyncWithHttpInfo (string direction)
        {
            // verify the required parameter 'direction' is set
            if (direction == null)
                throw new ApiException(400, "Missing required parameter 'direction' when calling MazeApi->Move");
