...
namespace IO.Swagger.Api
{
    ...
    public interface IPlayerApi : IApiAccessor
    {
        ...
        /// <param name="name">The name you wish to represent you in the leader board.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> RegisterWithHttpInfo (string name);
        ...
        /// <param name="name">The name you wish to represent you in the leader board.</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> RegisterAsyncWithHttpInfo (string name);
    ...
    public partial class PlayerApi : IPlayerApi
    {
        ...
        /// <param name="name">The name you wish to represent you in the leader board.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> RegisterWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling PlayerApi->Register");
        ...
        /// <param name="name">The name you wish to represent you in the leader board.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task RegisterAsync (string name)
        {
        ...
        /// <param name="name">The name you wish to represent you in the leader board.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> RegisterAsyncWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling PlayerApi->Register");
