...
namespace IO.Swagger.Model
{
    ...
    public partial class MazeInfo :  IEquatable<MazeInfo>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="name">The name of the maze. Might give you a hint regarding its structure..</param>
        /// <param name="totalTiles">How many tiles exist in this maze..</param>
        /// <param name="potentialReward">The total available reward in this maze..</param>
        public MazeInfo(string name = default(string), int? totalTiles = default(int?), int? potentialReward = default(int?))
        {
            this.Name = name;
