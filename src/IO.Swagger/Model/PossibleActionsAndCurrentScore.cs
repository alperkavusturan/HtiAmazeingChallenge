...
namespace IO.Swagger.Model
{
    ...
    public partial class PossibleActionsAndCurrentScore :  IEquatable<PossibleActionsAndCurrentScore>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="possibleMoveActions">The actions available on your surrounding tiles (lookahead of one tile)..</param>
        /// <param name="canCollectScoreHere">In the tile where you are standing, is it possible to collect score (from hand to bag)..</param>
        /// <param name="canExitMazeHere">In the tile where you are standing, is it possible to exit the maze. Remember you will lose any score in hand  and only be rewarded with the score you have in your bag..</param>
        /// <param name="currentScoreInHand">What is the score you currently have in your hand. Find a score collection point and issue a collect  score command to move this score into your bag. Score in your hand is not awarded when you exit a maze..</param>
        /// <param name="currentScoreInBag">What is the score currently in your bag. When you exit the maze this score will be rewarded to your total  overall score..</param>
        public PossibleActionsAndCurrentScore(List<MoveAction> possibleMoveActions = default(List<MoveAction>), bool? canCollectScoreHere = default(bool?), bool? canExitMazeHere = default(bool?), int? currentScoreInHand = default(int?), int? currentScoreInBag = default(int?))
        {
        ...
        public List<MoveAction> PossibleMoveActions { get; set; }
